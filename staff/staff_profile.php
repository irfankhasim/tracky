...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (($_POST['action'] ?? '') === 'profile') {
        ...
        $stmt = mysqli_prepare($conn, 'UPDATE users SET name=?, phone=? WHERE id=? AND role=\'staff\'');
...
<div class="page-header">
  <div class="page-header-left">
    <h4>Akaun Saya</h4>
    <p>Urus maklumat & tetapan peribadi anda</p>
  </div>
</div>
    ...
    <div class="stat-card">
      <div class="d-flex align-items-center gap-3">
        ...
        <div>
          ...
          <div class="stat-value" style="font-size:1.05rem">Staf</div>
        </div>
      </div>
    </div>
  </div>

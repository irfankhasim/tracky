...
$count_res = mysqli_query($conn, 'SELECT COUNT(*) AS c FROM notifications WHERE is_read = 0');
...
$result = mysqli_query($conn, "SELECT * FROM notifications ORDER BY created_at DESC LIMIT $limit");
$list = [];
if ($result) {

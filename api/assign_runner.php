...
$ostmt = mysqli_prepare($conn, "SELECT id, order_no, status FROM orders WHERE id = ? AND status = 'pending'");
...
try {
    ...
    addNotification($conn, 'Runner Assigned', "Order {$order['order_no']} telah di-assign.", 'delivery');
